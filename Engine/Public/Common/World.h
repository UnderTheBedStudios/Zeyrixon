...
public:
    ...
    const glm::vec3& LightDir() const { return m_lightDir; }
    const glm::vec3& LightColor() const { return m_lightColor; }
    ...
    const std::string& DefaultCameraName() const { return m_defaultCameraName; }
    ...
    const std::filesystem::path& FilePath() const { return m_zworldPath; }
